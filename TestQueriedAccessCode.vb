...
Public Class TestQueriedAccessCodeList
    Inherits System.Windows.Forms.Form
    Private cn As SqlClient.SqlConnection
    Private CodePattern As New str.Regex("(\b(?<AccLetter>(V[GM]|[XYZ][A-Z]|[BCDEF][A-GJ-NP-Z]))-?(?<AccNumber>\d{4})\b)+" _
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.btnCancel.Location = New System.Drawing.Point(11, 368)
        ...
        Me.btnOK.Location = New System.Drawing.Point(146, 368)
        Me.btnOK.Name = "btnOK"
        ...
        Me.btnClearList.Location = New System.Drawing.Point(157, 10)
        ...
        Me.rtfFreeList.Location = New System.Drawing.Point(12, 12)
        Me.rtfFreeList.Name = "rtfFreeList"
        Me.rtfFreeList.Size = New System.Drawing.Size(137, 328)
        ...
        Me.TextBox1.Location = New System.Drawing.Point(155, 72)
        Me.TextBox1.Multiline = True
        Me.TextBox1.Name = "TextBox1"
        Me.TextBox1.ReadOnly = True
        Me.TextBox1.Size = New System.Drawing.Size(107, 118)
...
#End Region
    ...
    Private Sub frmQueriedAccessCodeList_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'cn = CType(Me.Owner.Owner, frmCHCRTracker).SqlConnection1
  ...
  Private Sub LoadTextBox(Optional ByVal qac As TrackerData.QueriedAccessCodeListDataTable = Nothing)
    ' Dim s As String = String.Empty
    If IsNothing(qac) Then
      qac = TrackerApp.tracker1.QueriedAccessCodeList
    End If
    Dim s As New System.Text.StringBuilder
    For Each r As TrackerData.QueriedAccessCodeListRow In qac.Rows
  ...
  End Sub
    ...
    Dim dtQueriedAccessCodes As New TrackerData.QueriedAccessCodeListDataTable
        ...
        For Each line As String In Me.rtfFreeList.Lines
            If line.Length > 0 Then
                mc = Me.CodePattern.Matches(line)
                If mc.Count > 0 Then
                    For Each m1 In mc
              ...
              Dim r As TrackerData.QueriedAccessCodeListRow = .NewQueriedAccessCodeListRow
                            ...
                            Debug.Assert(r.AccLetter.Length > 0)
    ...
    Select Case badlines
      Case 0
        LoadTextBox(dtQueriedAccessCodes)
        Return True
      Case 1
